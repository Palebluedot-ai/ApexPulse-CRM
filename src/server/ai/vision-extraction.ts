...
export function buildVisionExtractionPrompt(): string {
  return [
    ...
    "不要把我方自我介绍、OTC team、James、杨超或右侧我方消息当成对方客户名。",
    "companyName 只有明确属于对方时才填；不能把 ApexPulse、群名、我方公司、群聊标题误当成对方公司。",
...
export function buildTextExtractionPrompt(): string {
  return [
    ...
    "不要把我方自我介绍、OTC team、James、杨超当成对方客户名。",
    "companyName 只有明确属于对方时才填；不能把 ApexPulse、我方公司误当成对方公司。",
